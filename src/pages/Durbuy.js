...
function Durbuy() {
    ...
    return (
        <div className='feed'>
            ...
            <Sidebar />
            <Location
                locationName="Rue du Manoir 127: Durbuy"
                ...
                weten of het huisje vrij is! De kosten zijn 100 euro per nacht. Honden zijn welkom en vergeet absoluut niet het
                laybyrint van Barvaux te bezoeken! "
